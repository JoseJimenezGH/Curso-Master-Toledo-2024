...
#                                                                              #
#==============================================================================#
setwd('C:/Users/Usuario/OneDrive/00 Master Seguimiento de la Diversidad Biológica 2023/AulaVirtual/04 SCR/Modelos avanzados')
library(nimble)
library(coda)
library(lattice)
library(scrbook)
...
start.time2<-Sys.time()  # Uso sólo 1 cadena para ahorrar tiempo
